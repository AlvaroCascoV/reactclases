...
class Contador extends Component{
    ...
    numero = 1;
    //CON LOS METODOS SUCEDE EXACTAMENTE LO MISMO, SOLO LA DECLARACION
    incrementarNumero = () => {
        //PARA ACCEDER A LAS VARIBABLES DE CLASE, DEBEMOS UTILIZAR
    ...
    render(){
        return(<div>
            ...
            }}>Otra sintaxis con función anónima Lambda</button>
        </div>)
    }
}
